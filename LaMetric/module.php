<?
	...
	// Lese alle Konfigurationsdaten aus
		...
		if (isset($data)){
			...
			if (isset($data->wifi->strength)) SetValue(IPS_GetObjectIDByName("WLan Empfang", $this->InstanceID),$data->wifi->strength);
		}
	...
	public function notification(string $notification, string $icontype, string $icon, string $sound) {
